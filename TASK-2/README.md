...
<h3 align="left">Калькулятор</h3>
<p align="left">Створити віконну програму в якій реалізувати основні функції
калькулятора. (cos, sin, tan, ctg, log, ln,%)</p>

<p align="left">Реалізувати в програмі додаткові функції.</p>
<kbd>
```python
from tkinter import *
import math
